...
flags.DEFINE_integer('input_width', 416, 'image width')
flags.DEFINE_integer('input_height', 416, 'image height')
...
def representative_data_gen():
  ...
  for input_value in range(10):
    if os.path.exists(fimage[input_value]):
      ...
      image_data = utils.image_preprocess(np.copy(original_image), [FLAGS.input_width, FLAGS.input_height])
